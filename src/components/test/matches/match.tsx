...
const Match = (props) => {
    ...
    console.log('챔>>>', data.summoner1Id)
    ...
    return (
        ...
        >
            <InfoDiv>
                ...
                <SpellDiv>
                    <div>
                        <img
                            ...
                            src={
                                ...
                                Spells.find((el) => el.id === data.summoner1Id)
                                    .name +
                                '.png'
                            }
                        />
                    ...
                    <div>
                        <img
                            ...
                            src={
                                '  http://ddragon.leagueoflegends.com/cdn/12.5.1/img/spell/Summoner' +
                                Spells.find((el) => el.id === data.summoner2Id)
                                    .name +
                                '.png'
                            }
                        />
                ...
                <PlayersDiv>
                    <TeamDiv>{renderTeamIcons(participants, true)}</TeamDiv>
                    <TeamDiv>{renderTeamIcons(participants, false)}</TeamDiv>
                </PlayersDiv>
                <ItemDiv>
